...
linuxDash.config(['$routeProvider',
    function($routeProvider) {
        ...
        $routeProvider.
          ...
          when('/network-info', {
            templateUrl: 'templates/sections/network-info.html',
          }).
          when('/account-info', {
            templateUrl: 'templates/sections/account-info.html',
          }).
          when('/ps-info', {
            templateUrl: 'templates/sections/ps-info.html',
          }).
          when('/disk-info', {
            templateUrl: 'templates/sections/disk-info.html',
          }).
          otherwise({
